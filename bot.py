...
async def edit_work(ctx, unique_id: str = None, new_start: str = None, new_end: str = None):
    ...
    embed.add_field(name="User", value=f"{entry['discord_name']}", inline=False)
    embed.add_field(name="Old Start Time", value=old_start_time, inline=True)
    embed.add_field(name="Old End Time", value=old_end_time, inline=True)
    embed.add_field(name="New Start Time", value=new_start_time.strftime('%Y-%m-%d %H:%M'), inline=True)
    embed.add_field(name="New End Time", value=new_end_time.strftime('%Y-%m-%d %H:%M'), inline=True)
